    ...
    <html lang="pt-BR">
      ...
      <body>
        <div class="container">
          ...
          <p>Olá, ${username}!</p>
          <p>Estamos felizes por ter você conosco. Agora ficou fácil gerenciar a rotina de trabalho.</p>
          <p>Para começar, basta acessar sua conta e explorar nossos serviços.</p>
