...
export class TypeService {
  ...
  create(createTypeDto: CreateTypeDto, companyId: string) {
    return this.prisma.companyOccurrenceType.create({
      data: {
        ...createTypeDto,
        company: {
          connect: {
  ...
  findAll(companyId: string) {
    return this.prisma.companyOccurrenceType.findMany({
      where: {
        companyId: companyId,
        deleted: false,
      },
  ...
  async findOne(typeId: string, companyId: string) {
    const type = await this.prisma.companyOccurrenceType.findFirst({
      where: {
        id: typeId,
        companyId: companyId,
        deleted: false,
  ...
  async update(
    ...
    return this.prisma.companyOccurrenceType.update({
      where: {
        id: typeId,
      },
      data: updateTypeDto,
